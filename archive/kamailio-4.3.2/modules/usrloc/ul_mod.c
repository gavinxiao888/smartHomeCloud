...
#define COMMONADDRESS_COL      "common_address"
...
str commonaddress_col  = str_init(COMMONADDRESS_COL);  /*!< Name of column containing the commonaddress value*/
...
static param_export_t params[] = {
	...
	{"commonaddress_column",PARAM_STR, &commonaddress_col},
