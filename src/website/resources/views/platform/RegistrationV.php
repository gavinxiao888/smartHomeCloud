...
<div class="cont-head"> 
	...
	<p style="margin-left:30px;">注册爱悠账号可以享受爱悠的一切服务。如果已有账号，<a href="/user/login" style="color:#CC9933;">请登陆。</a></p>
</div>
<div class="form">
<table  cellspacing="0" cellpadding="0" >
	...
	<tr>
		...
		<img src="/code/platformcode" style="width:100px;height:34px;float:left;margin-left:10px;float:left;padding-left:5px;height:30px;margin-top:3px;" id="codeimg" title="点击图片刷新验证码" />
