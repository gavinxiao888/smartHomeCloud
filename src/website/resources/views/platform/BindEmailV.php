 ...
 function code()//验证验证码
 {
  ...
  if(state)
  {
   $.ajax(
       {
        type:"post",
        url:"/user/platform_bindeamail_code",
...
<div class="content"> 
<div class="cont-head"> 
<h4><a href="/user/account">爱悠账号</a>&nbsp;>&nbsp;<font style="color:#ec680c">绑定邮箱</font></h4>
<h6><?php
...
<div class="arrow">
<div class="arrow1">
<span class="span1">&nbsp;1&nbsp;输入邮箱</span>
<strong class="strong1"></strong>
</div>
<div class="arrow2">
<strong class="strong2"></strong>
<span class="span2">&nbsp;2&nbsp;验证邮箱</span>
...
<table style="margin:0 auto;">
	<tr id="enter_email">
		<td style="text-align:left;width:180px;">请输入您要绑定的邮箱:&nbsp;</td>
		<td><input class="form-control" type="text" style="width:30%;min-width:200px;float:right;display:block" id="email" onBlur="email()"/></td>
		<td><div id="showemail" style="color:red;display:none">邮箱不符合规则</div></td>
	</tr>
	<tr id="enter_code" style="display:none">
		<td style="text-align:left;width:180px;">请输入您邮箱中的验证码</td>
	...
	<tr id="third_step" style="display:none">
		<td style="text-align:left;width:180px;">邮箱验证完成</td>
