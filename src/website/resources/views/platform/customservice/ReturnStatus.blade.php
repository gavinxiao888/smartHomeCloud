@extends('platform.personalcenter.Default')
	...
	<div class="navi-left">
		...
		<ul>
			...
			<li class="hit"><a href="/customservice/return" >退换货</a></li>
		</ul>
		<ul>
	...
	<div class="news">
			...
			<div class="returndiv">
				<table class="returndivtable">
					...
					<tr style="height:120px;text-align:center;">
						...
						<td id="devicetype" style="border-left:1px solid #dadada;border-top:1px solid #dadada;">退货中</td>
		...
		<div style="float:left;width:700px;margin-top:20px;margin-bottom:10px;margin-left:30px;">
			...
			<div style="float:left;width:33%;">买家退换货申请</div><div style="float:left;width:31%;text-align:right;">商家处理退换货申请</div><div style="float:left;width:36%;text-align:right;">退换货完成</div>
		</div>
		...
		<div style="margin-left:30px;float:left;width:700px;display:none;" id="returnreason">
			<form method="post" id="form1" action="/customservice/addreturn" enctype="multipart/form-data">
				<p>选择类型：<input type="radio" id="radioreturn" name="radiotype" value="0" checked="checked" />退货 
					<input type="radio" id="radiochenge" name="radiotype" value="1" />换货
				</p>
				<p><textarea id="reason" name="reason" placeholder="请输入原因" style="width:700px;height:120px;resize:none;overflow-y:auto;font-size:16px;"></textarea></p>
