...
<title>注册爱悠账号</title>
 ...
 <link href="/site/css/registration.css" rel="stylesheet"/>
...
//		var reg= /^([0-9]+[a-zA-Z_]+[A-Za-z_0-9]+)|([a-zA-Z_]+[0-9]+[A-Za-z_0-9]+)$/;
	...
	function changing(){
    document.getElementById('checkpic').src="/code/checkCode.php?"+Math.random();
	} 
    function keyUp(e) {
...
<div class="head" style="">
	<img src="/site/images/logo1.png"/>
</div>
<!--头部结束-->
<!--content开始-->
<div class="content"> 
<div class="cont-head"> 
	<h4 style="color:#ec680c;margin-left:30px;font-weight:bold">注册爱悠账号</h4>
	<p style="margin-left:30px;">注册爱悠账号可以享受爱悠的一切服务。如果已有账号，<a href="/users/login" style="color:#CC9933;">请登陆。</a></p>
</div>
<div class="form">
<table  cellspacing="0" cellpadding="0" >
	...
	<tr>
		...
		<td style="overflow:hidden;font-size:14px;"><div id="showpass" style="color:red;text-align:left;width:255px;">长度为8-16位，至少包含数字、字母、下划线的两种</div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="form-control" type="text" id="code" onKeyUp="code()" onBlur="code()" style="width:100px;display:block;float:left;"/>&nbsp;&nbsp;&nbsp;&nbsp;
		<img src="/code/platformcode.php" style="width:100px;height:34px;float:left;margin-left:10px;float:left;padding-left:5px;height:30px;margin-top:3px;" id="codeimg" title="点击图片刷新验证码" />
		<span class="iron" onClick="changeCode()"></span><span class="iok" id="iok"></span></a></td>
		<td><div id="showcode" style="color:red"></div></td>
	</tr>
	<tr>
		<td class="span"></td>
		<td><a type="button" style="background:#ec680c;cursor:pointer;float:left;display:block;width:109px;line-height:30px;margin:0 auto;border-radius:5px;text-align:center" onClick="registration()"><font style="color:#ffffff">确认</font></a></td>
		<td></td>
	</tr>
</table>
<p style="text-align:center">点击立即注册，即表示您同意并愿意遵守爱悠<a href="＃" style="color:#CC9933">用户协议</a>和<a href="＃" style="color:#CC9933">隐私政策</a></p>
</div>
</div>
<!--content结束-->
<!--页脚开始-->
